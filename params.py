...
# main_path = '/media/karim/79DE901F11ABED4C/Dimitriy/resting_data/'
main_path = '/home/dmalt/Dropbox/aut_gamma/'
...
# "R0061", "R0062"
# ]
# subject_ids_all = ['K0033', 'K0017', 'R0060']
# subject_ids_all = ['R0030', 'R0032', 'R0037', 'R0061', 'K0014', 'K0020', 'K0008']
# subject_ids_all = ['K0001', 'K0002', 'K0004', 'K0005','K0006', 'R0001', 'R0003', 'R0004', 'R0005', 'R0006', 'R0007']
# subject_ids_all = ['K0001', 'K0002']
# subject_ids_all = ['R0002']
# subject_ids_all = ['R0002','R0042',  'R0030', 'R0032', 'R0037', 'K0014', 'R0050', 'R0044', 'R0045', 'R0049', 'R0061', 'K0043', 'K0046', 'K0045', 'K0047']
# subject_ids_all = ['K0019', 'K0024', 'R0018']
subject_ids_all = ['R0008', 'K0034', 'R0023', 'K0025']

sessions = ["01"]

# subject_ids_exclude_perm = ['K0009', 'K0023', 'K0034', 'R0025', 'R0027', 'R0013', 'R0049']
subject_ids_exclude_perm = []
...
#                             'K0003', 'K0006', 'K0039', 'R0007', 'K0005']
subject_ids_exclude_temp = []

subject_ids = [x for x in subject_ids_all if x not in subject_ids_exclude_perm and x not in subject_ids_exclude_temp]
